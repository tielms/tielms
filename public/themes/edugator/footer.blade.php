            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="footer-widget-wrap">
                        ...
                        <p class="footer-about-us-desc">
                            Tielearn academy connects Teachers with Students globally. Teachers crate high quality course and present them in super easy way. Tielearn academy created by <a href="https://tielearn.com" target="_blank">tielearn</a>
                        </p>
                        <p class="footer-social-icon-wrap">
                            <a href="https://www.facebook.com/tielearn"><i class="la la-facebook"></i> </a>
                           <a href="https://twitter.com/tielearn"><i class="la la-twitter"></i> </a>
                           <a href="https://linkedin.com/company/tielearn"><i class="la la-linkedin"></i> </a>
                            <a href="https://www.youtube.com/user/softmasr"><i class="la la-youtube"></i> </a>
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="footer-widget-wrap contact-us-widget-wrap">
                        ...
                        <p class="mb-0"> info@tielearn.com </p>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="footer-bottom-contents-wrap d-flex">
                        ...
                        <div class="footer-bottom-left d-flex">
                            <h5 class="text-warning">Tielearn academy</h5>
                            <span class="ml-4">Copyright © 2020 Tielearn. All rights reserved.</span>
                        </div>
...
<script>
    document.getElementById("tielearn_register").onclick = function () { analytics.goal('z7x2opon9yo6nvew') };
</script>
