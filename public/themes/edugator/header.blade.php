...
<head>
    ...
    <meta name="description" content="Tielearn is a platform that allows instructors to build online courses on their preferred topics. Using Tielearn's course development tools, they can upload videos, PowerPoint presentations, PDFs, audio, ZIP files and live classes to create courses. Instructors can also engage and interact with users via online discussion boards." />
    <meta name="keywords" content="Tielearn, courses, online courses, mentorship, learn programming, programming courses, online arabic courses" />
...
<!-- style css -->
    ...
    <!-- Pixel Code for https://dashboard.hotfunnel.io/ -->
    <script defer src="https://dashboard.hotfunnel.io/pixel/x4EY32bb3dIcr2Wk"></script>
    <!-- END Pixel Code -->
</head>
